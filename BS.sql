--ANTES DE EMPEZAR:
        ...
        -- EJECUTE LA INSERCION DE TABLAS Y CREACION DE USUARIO PROPORCIONADA EN LA EVALUACION
        -- PRIMERO DEBE CREAR TABLAS , SECUENCIAS, TRIGGERS, PACKAGES DE ESTE CODIGO, EN ESE ORDEN, PARA LUEGO EJECUTAR EL SCRIPT PRINCIPAL
        -- DEBE CONTAR CON VALORES LA TABLA MONTO_INGRESO PARA HACER LAS VALIDACIONES, INGRESELAS MANUALMENTE
        -- EL SISTEMA YA PROTEGE DE SOBREESCRITURA DE DATOS
